...
* chore(deps): bump ramsey/composer-install from 3 to 4 by @dependabot[bot] in https://github.com/jeffersongoncalves/filament-satis/pull/9
* chore(deps): bump dependabot/fetch-metadata from 2.5.0 to 3.0.0 by @dependabot[bot] in https://github.com/jeffersongoncalves/filament-satis/pull/10
* chore(deps): bump actions/checkout from 6 to 7 by @dependabot[bot] in https://github.com/jeffersongoncalves/filament-satis/pull/11
* docs: add Buy Me a Coffee sponsor link by @jeffersongoncalves in https://github.com/jeffersongoncalves/filament-satis/pull/12
* chore: add GitHub Sponsors to FUNDING.yml by @jeffersongoncalves in https://github.com/jeffersongoncalves/filament-satis/pull/15
* ci: standardize update-changelog workflow (3.x) by @jeffersongoncalves in https://github.com/jeffersongoncalves/filament-satis/pull/20
* ci: standardize dependabot config by @jeffersongoncalves in https://github.com/jeffersongoncalves/filament-satis/pull/21
* ci: standardize tests workflow (3.x) by @jeffersongoncalves in https://github.com/jeffersongoncalves/filament-satis/pull/26
* feat(i18n): add translations (3.x) by @jeffersongoncalves in https://github.com/jeffersongoncalves/filament-satis/pull/29

**Full Changelog**: https://github.com/jeffersongoncalves/filament-satis/compare/3.12.0...3.13.0
...
- Add Laravel 13.x support (orchestra/testbench ^11.0, CI test matrix)
